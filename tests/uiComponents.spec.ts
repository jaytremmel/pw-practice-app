...
test('checkboxes', async({page}) => {
    ...
    //below also works, I did it. declared const as locator then used the .click method to uncheck/check the box
...
test('web tables', async({page}) => {
    ...
    //get the row based on the value 
...
test('datepicker', async({page}) => {
    ...
    const dateCells = page.locator('[class="day-cell ng-star-inserted"]').getByText(expectedDate, {exact: true});
